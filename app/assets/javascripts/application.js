...
function setUpAccordion(data) {
    ...
    for (let category in data.requirement.categories) {
        ...
        for (let c in courseArr) {
            ...
            newHtml += "<li id='" + course.course + "' " + courseClass + "' draggable='true' ondragstart='drag(event)'>" + courses[course.course].courseID + " " + courses[course.course].courseName + "</li>";
        }
...
(function(root, factory) {
    ...
    Snackbar.show = function($options) {
        ...
        Snackbar.snackbar.style.borderRadius = "5px";
        Snackbar.snackbar.style.boxShadow = "2px 2px 3px rgba(0,0,0,0.4)";
        ...
        if (options.showAction) {
            ...
            actionButton.style.fontSize = "1.3em";
